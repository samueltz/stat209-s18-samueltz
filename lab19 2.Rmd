...
**Answer**: The model predicted the mean of the yelp scores for all burrito restaurants to be between 3.8 and 4.1 with a 95% confidence level. 3.7 does not fall in this range so it is safe to say that burrito places have higher average yelp scores than other restuarants. 
...
**Answer**: The sample that the students picked was more than likely not a random sample, and consisted of onlt the best burrito places.
...
**Answer**: The slope coefficient means that the mean yelp rating of burrito places with chips included is predicted to be about 0.06 higher than burrito places without chips included.

Is the slope coefficient statistically significant (compared to zero)?

**Answer**: The slope coefficient is not statistically significant, because it contains zero in its error range.

Describe this in terms of your answers above.

**Answer**: The slope is predicted to be between -0.21 and 0.32 with a 95% confidence level, meaning that the mean yelp score is most likely between -0.21 lower and 0.32 points higher. Since it could be either lower or higher, no conclusions can be drawn.
...
**Answer**:No, because the the range of possible means between low and high synergy places overlap.
...
**Answer**:The model predicts that it will have an average synergy of between 2.5 and 2.9 with a 95% confidence level.

What does the model predict will be the overall score of a location with
high synergy?

**Answer**: The model predicts that the average score for high synergy locations is 3.4 to 4.4.
...
**Answer**: The overall score will be between about 1.1 and 2.4.
