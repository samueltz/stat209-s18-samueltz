...
Answer:There is a positive linear relationship between the mass of a male bird and the mass of an egg.
...
ggplot(birds, aes(male_mass, egg_mass)) +
  ...
  scale_x_log10() +
  scale_y_log10() +
  annotate("text", x = 100, y = 1, label = "Red dots are parrots") +
...
Answer:The line looks like it matches the linear relationship between bird mass and egg mass.
...
ggplot(birds, aes(male_mass, egg_mass)) +
  ...
  scale_y_log10() +
  geom_smooth(method = "lm", color = "black", se = FALSE, linetype = "dashed", size = 0.5) +
  annotate("text", x = 225, y = 105, label = "Red-tailed tropicbird")
```
...
ggplot(birds, aes(male_mass, egg_mass)) +
  ...
  geom_smooth(method = "lm", color = "black", se = FALSE, linetype = "dashed", size = 0.5)+
  scale_color_viridis() +
  annotate("text", x = 1000, y = 2, label = "0 -> 2 increases with less male-female competition for resources") +
  xlab("Mass of Male Birds") +
  ylab("Mass of Eggs") +
  ggtitle("Mass of Eggs, vs. Mass of Males")
