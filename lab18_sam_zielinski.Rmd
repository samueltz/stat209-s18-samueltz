...
```{r}
model <- lm_basic(base ~ 1, data = master)

reg_table(model, level = 0.95)
```
the masters data has a slightly higher mean, but the two still intersect.
## Murder Data
...
**Answer**: The range of the mean will be correctly estimated only 80% of the time.
