...
```{r}
ggplot(birds_type, aes(male_mass_mean, egg_mass_mean)) +
  geom_point() +
  scale_x_log10() +
  scale_y_log10()
```
...
ggplot(birds_type, aes(male_mass_mean, egg_mass_mean)) +
  ...
  geom_point(data = birds_2, aes(y = egg_mass_mean), color = "red", alpha = 0.3) +
  geom_text(data = birds_2, aes(label = type), size = 3) +
  scale_x_log10() +
  scale_y_log10()
```
