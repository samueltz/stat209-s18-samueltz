...
**Answer**: 34.5. This means that about 30% of cereal scored 34.5 or lower, or that about 70% of cereal scored 34.5 or higher.
...
**Answer**: Nabisco seems to have the healthiest overall cereals, but kellogs has the overall most healthy single cereal.
...
**Answer**: The top shelf, with the bottom shelf being close behind.
...
**Answer**: score tends to increase as the number of reviews increases. 
...
**Answer**: the 80th percentile is 30.00 dollars per cup of tea. This means that about 80% of the teas cost less than 30.00 dollars per cup, while about 20% cost more than $30.00 per cupo.
...
**Answer**: The most expensive 20% of teas have the least number of reviews.
...
**Answer**: The variation of the price of white tea is smaller than that of the entire data set.
...
**Answer**: The masters teas are far more expensive than any of the other teas. Matcha teas, on the other hand, are the second most expensive tea, but vary the most from the group in the average rating.
